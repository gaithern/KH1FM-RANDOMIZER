    ...
    while i < len(keyblade_list):
        if "STR" in keyblade_stats_data[i].keys():
            ...
            if offset is not None:
                battle_table_data[offset] = keyblade_stats_data[i]["STR"]
